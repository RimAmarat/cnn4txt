...
class MyDataset(data.Dataset):
    ...
    def from_csv(cls, text_field, label_field, csv_path, **kwargs):
        ...
        for index, row in df.iterrows():
            ...
            #print("note", label)
            examples.append(data.Example.fromlist([text, label], fields=[('text', text_field), ('label', label_field)]))        
    ...
    def test_from_csv(cls, text_field, csv_path, **kwargs):
        ...
        for index, row in df.iterrows():
            ...
            examples.append(data.Example.fromlist([text, None], fields=[('text', text_field), ('label', None)]))
